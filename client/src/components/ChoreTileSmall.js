  ...
  let tileContent = (
    <div className="cell small-12 medium-6 large-3 chore-tile-small">
      ...
      <p>
        ...
        <span className="button-styling-small-delete" onClick={onDeleteClick}>Delete</span>
      </p>
    </div> 
  )
  ...
  if (showDelete) {
    tileContent = (
      <div className="cell small-12 medium-6 large-3 chore-tile-small-delete-confirm">
        ...
        <p>This will delete the chore, including from your child's dashboard. The child will not receive payment, even if it was pending acceptance as complete.</p>
        <span className="button-styling-small-delete" onClick={handleDelete}>Confirm Chore Delete</span>
        <span className="button-styling-small" onClick={cancelDelete}>Cancel</span>
      </div>
    )
  }
